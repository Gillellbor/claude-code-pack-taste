...
feeds them the same way. Claude Code is the reference implementation; its behavior
is preserved byte-for-byte from the original bash-safety-extended.py hook.
