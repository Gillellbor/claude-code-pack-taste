...
<output_language>
Language routing and native-Czech quality are owned by `~/.claude/rules/language.md`: English by default for everything generated (system files, code, docs); Czech in conversation and in human-read deliverables for the team's audience. System files carry no personal or client-specific identifiers.
</output_language>
